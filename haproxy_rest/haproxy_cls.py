...
# ha.enable_server({"backend": "backend", "server": "redirect01"})
...
#
# now = time()
# [print(stat) for stat in
#  (stat['backend'] for stat in stats_list if 'backend' in stat)
#     if 'redirect01' in stat]
# then = time()
# print(then - now)
#
#
...
# for stats in stats_list:
#     try:
#         print(stats['frontend']['FRONTEND'])
#     except KeyError:
#         pass
#
# def find_stats(list, type, svname=None):
#     if svname == None:
#         for stats in list:
#             try:
#                 print(stats[type])
...
#
# now = time()
# find_stats(stats_list, 'backend', 'redirect01')
# then = time()
# print(then - now)
#
#
#
#
# # print(list(filter(lambda value: value['backend'] == 'redirect02', stats_list)))
#
# # print('backend' in stats_list[2])
#
#
#
#
...
# #     stats.append(dict(zip(key, values_list)))
# #
# # print(stats)
